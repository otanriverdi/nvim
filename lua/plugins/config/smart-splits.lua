return {
  ...
  init = function()
    local mappings = {
      n = {
        ["<C-A-h>"] = { ":lua require('smart-splits').resize_left()<CR>", "resize left" },
        ["<C-A-j>"] = { ":lua require('smart-splits').resize_down()<CR>", "resize down" },
        ["<C-A-k>"] = { ":lua require('smart-splits').resize_up()<CR>", "resize up" },
        ["<C-A-l>"] = { ":lua require('smart-splits').resize_right()<CR>", "resize right" },
